...
export HOMEBREW_TAP_TOKEN=your_github_token_here
```
...
Create the tap at: `https://github.com/aaronsrivastava/homebrew-tap`

The structure should be:
```
homebrew-tap/
├── Formula/
│   └── substack-cli.rb (auto-generated by GoReleaser)
└── README.md
```
